...
var CashflowoutCollection = "cashflowout"


func NewCashflowoutCollection(app *pocketbase.PocketBase) {
	collection := &models.Collection{
		Name: CashflowoutCollection,
		Schema: schema.NewSchema(
			...
			&schema.SchemaField{Name: "type", Type: schema.FieldTypeSelect, Options: schema.SelectOptions{Values: []string{"variable", "fixed", "investment", "saving"}}, Required: true},
